<i18n>
{
  "tr": {
    "title": "Değerlerimiz",
    "description": "smileizmir olarak değerlerimiz başta Hasta ve Çalışan Haklarına Saygı Duymak, Bilimsel Esasları Temel Almak vd.",
  ...
  "en": {
    "title": "Our Values",
    "description": "As smileizmir, our values are Respecting Patient and Employee Rights, Taking Scientific Principles as a Basis, etc.",
  ...
  "de": {
    "title": "Unsere Werte",
    "description": "Als smileizmir sind unsere Werte: Achtung der Rechte von Patienten und Mitarbeitern, Berücksichtigung wissenschaftlicher Grundsätze usw.",
    "subtitle": "Smile Izmir Aesthetic Oral and Dental Health Polyclinic",
